...
class MainWindow(QWidget):
    ...
    expert_mode_index_signal = Signal(int)
    ...
    def __init__(self):
        ...
        self.expert_mode_index_signal.connect(self.settings.change_expert_mode_index)
    ...
    def change_expert_mode(self, index):
        ...
        self.expert_mode_index_signal.emit(index)
    ...
    def adjust_expert_interface(self):
        ...
        self.adjust_available_functions()

    def adjust_available_functions(self):
        if self.ai_model == '':
